...
def main():
    ...
    filepath="./record/weights-1-vgg16-newset-{epoch:05d}-{val_binary_accuracy:.2f}.hdf5"
    checkpoint = ModelCheckpoint(filepath, monitor='val_binary_accuracy', verbose=1,period=periods)
    filepath2="./record/weights-1-vgg16-newset-acc-best.hdf5"
    filepath3="./record/weights-1-vgg16-newset-val-best.hdf5"
    ...
    callbacks_list = [checkpoint,checkpoint2,checkpoint3,TensorBoard(log_dir='./lognewset')]
